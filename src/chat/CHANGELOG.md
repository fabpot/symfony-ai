 ...
 * [BC BREAK] Persist thinking parts with their representation and nested provider state; legacy signatures are retained as unknown-format state without inferring a representation
